...
class TestNestedStructures(unittest.TestCase):
    ...
    def test_complex_heterogeneous_data_structure(self):
        ...
        self.assertEqual(data["metadata"]["source"]["endpoint"], "https://api.example.com/v2/data")
        ...
        self.assertAlmostEqual(headphones["specs"]["performance"][1]["scores"]["wireless"], 28.5)
        
        # Check pagination
        self.assertEqual(data["pagination"]["total_results"], 2)
        self.assertEqual(data["pagination"]["links"]["last"], 
    ...
    def test_json_fragment_extraction(self):
        ...
        for obj in result:
            if isinstance(obj, dict):
                ...
                self.assertFalse("imbalanced" in obj, 
